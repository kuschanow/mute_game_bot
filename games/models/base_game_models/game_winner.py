...
class GameWinnerMeta(models.base.ModelBase):
    def __new__(cls, name, bases, dct):
        new_class: GameWinnerBase = super().__new__(cls, name, bases, dct)  # type: ignore
...
class GameWinnerBase(models.Model, metaclass=GameWinnerMeta):
    game_name = ""
