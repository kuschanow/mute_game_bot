...
class AccessSettingsObject(models.Model):
    ...
    hide_in_stats = models.BooleanField(default=False, null=False)
    ...
    def get_owner_settings():
        return (AccessSettingsObject.objects.get_or_create(
    ...
    def __str__(self):
        return (f"[can_join_games: {self.can_join_games}] - [can_create_games: {self.can_create_games}] - [can_press_other_buttons: {self.can_press_other_buttons}]"
                ...
                f" - [is_invulnerable: {self.is_invulnerable}] - [hide_in_stats: {self.hide_in_stats}]")
